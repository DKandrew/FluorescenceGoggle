...
namespace HoloToolkit.Sharing
{
    ...
    public class SharingStage : Singleton<SharingStage>
    {
        ...
        /// <summary>
        /// True if it is the sharing master, false if it is the slave
        /// </summary>
        public bool IsSharingMaster
        {
            get
            {
                return false;
        ...
        /// <summary>
        /// Check whether this HoloLens is the only user 
        /// Note, every hololen, even when joining a sharing hololens group will have a short period of time that 
        /// IsOnlyUser is true
        /// </summary>
        public bool IsOnlyUser
        {
            get
            {
                return SessionUsersTracker.CurrentUsers.Count <= 1;
            }
        }
