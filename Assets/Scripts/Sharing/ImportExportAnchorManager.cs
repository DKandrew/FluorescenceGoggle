...
namespace HoloToolkit.Sharing
{
    ...
    /// </summary>
    /// <remarks>It will create anchors in the gameObject where this script is attached to</remarks>
    public class ImportExportAnchorManager : Singleton<ImportExportAnchorManager>
    {
        ...
        /// <summary>
        /// Called once the anchor has fully downloaded
        /// </summary>
        public event Action<bool> AnchorDownloaded;

        /// <summary>
        /// Called when the anchor start uploading/downloading
        /// </summary>
        public event Action AnchorLoading;
        ...
        private IEnumerator InitRoomApi()
        {
            ...
            while (currentRoom == null)
            {
                ...
                {
                    // Put the master/slave checker here
